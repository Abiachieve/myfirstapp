        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li className={props.data.reportsEnabler?'':'text-muted'}><span className="fa-li"><i className={props.data.reportsEnablerportEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.data.reports}</li>
            </ul>
